...
public class SqlQueryParserLimitTest {
    ...
    public void testLimitWithOffset() {
        ...
        assertThat(sqlQueryParser.getLimit(select).getOffset()).isEqualTo(1);
        assertThat(sqlQueryParser.getLimit(select).getRowCount()).isEqualTo(1);
    }
    ...
    public void testLimitWithOutOffset() {
        ...
        Select select = sqlQueryParser.parseSqlQuery(sqlQuery);
        assertThat(sqlQueryParser.getLimit(select).getOffset()).isEqualTo(0);
        assertThat(sqlQueryParser.getLimit(select).getRowCount()).isEqualTo(1);
    }
    ...
    public void testQueryWithOutLimit() {
        ...
        Select select = sqlQueryParser.parseSqlQuery(sqlQuery);
        assertThat(sqlQueryParser.getLimit(select)).isNull();
    }
}
